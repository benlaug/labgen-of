...
opt_desc(
  "LaBGen-OF - Copyright - Benjamin Laugraud <blaugraud@ulg.ac.be> - 2017\n"
  "http://www.montefiore.ulg.ac.be/~blaugraud\n"
  "http://www.telecom.ulg.ac.be/labgen\n\n"
...
int32_t ArgumentsHandler::get_t_param_int() const {
  return t_param_int;
}

/******************************************************************************/

double ArgumentsHandler::get_t_param() const {
  return t_param;
}
...
void ArgumentsHandler::parse_t_param() {
  if (!default_set) {
