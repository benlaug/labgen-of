...
DualTVL1Flow::DualTVL1Flow() : dual_tvl1_flow(createOptFlow_DualTVL1()) {}

/******************************************************************************/

void DualTVL1Flow::compute_flow(
  const Mat& previous_frame,
  const Mat& current_frame,
  Mat& optical_flow
) {
  dual_tvl1_flow->calc(previous_frame, current_frame, optical_flow);
}

/******************************************************************************/

int DualTVL1Flow::get_frame_type() {
  return CV_8UC1;
}
